...
Set-EnvDefault -Name "WKV_ADVISORY_LLM_STATUS_URL" -Value "http://127.0.0.1:8790/llm/status"
Set-EnvDefault -Name "WKV_ADVISORY_LLM_CONTROL_URL" -Value "http://127.0.0.1:8790/llm/control"
Set-EnvDefault -Name "WKV_ADVISORY_LLM_MODE" -Value "openvino_local"
Set-EnvDefault -Name "WKV_ADVISORY_TIMEOUT_SEC" -Value "60"
...
if (-not $Quiet) {
  ...
  Write-Host "  WKV_ADVISORY_TIMEOUT_SEC=$([Environment]::GetEnvironmentVariable('WKV_ADVISORY_TIMEOUT_SEC','Process'))"
